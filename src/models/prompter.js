...
export class Prompter {
    ...
    async promptConvo(messages) {
        ...
        for (let i = 0; i < 3; i++) { // try 3 times to avoid hallucinations
            ...
            try {
                generation = await this.chat_model.sendRequest(messages, prompt, undefined, this.agent.name);
    ...
    async promptCoding(messages) {
        ...
        let resp = await this.code_model.sendRequest(messages, prompt, undefined, this.agent.name);
        this.awaiting_coding = false;
    ...
    async promptMemSaving(to_summarize) {
        ...
        let resp = await this.chat_model.sendRequest([], prompt, undefined, this.agent.name);
    ...
    async promptShouldRespondToBot(new_message) {
        ...
        let res = await this.chat_model.sendRequest([], prompt, undefined, this.agent.name);
    ...
    async promptGoalSetting(messages, last_goals) {
        ...
        let res = await this.chat_model.sendRequest(user_messages, system_message, undefined, this.agent.name);
